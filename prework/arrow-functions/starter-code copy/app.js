...
// When an arrow function is used, the THIS reffers to the enclosing scope, which, in this case, is 
//the window scope.This because the arrow function does not create its own scope to operate.