...
function displayPics() {
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT: because it was declared into a block of code which means a scope was created and the varibale was declared in it.
  //Since, we use let, any variable declared  in a local scoope will not be recognized outside the block even if it was not a function block.
  console.log(viewed);
